    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerMovie", x => new { x.FavoriteCustomersId, x.FavoriteMoviesId });
                    table.ForeignKey(
                        name: "FK_CustomerMovie_Customers_FavoriteCustomersId",
                        column: x => x.FavoriteCustomersId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerMovie_Movies_FavoriteMoviesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerMovie_FavoriteMoviesId",
                table: "CustomerMovie",
